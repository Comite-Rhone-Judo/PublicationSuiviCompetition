...
<xsl:stylesheet version="1.0"
	...
	<xsl:variable name="IsIntegral">
		<xsl:choose>
			<xsl:when test="//phase[1]/@niveauRepechage = 6 and //phase[1]/@niveauRepeches = 7">
				<xsl:text>true</xsl:text>
			</xsl:when>
			<xsl:otherwise>
				<xsl:text>false</xsl:text>
			...
			<head>
				...
				<link rel="stylesheet" type="text/css" >
					<xsl:attribute name="href">
						file:///<xsl:value-of select="$style"/>style_feuille_tableau_128.css
					</xsl:attribute>
				</link>
				<title>-60</title>
			</head>
				...
				<table>
						...
						<table class="t1" >
							<tr>
								<td rowspan="1" class="td_texte1">
									<xsl:for-each select="key('combats','7')">
								...
								<td rowspan="2" class="td_texte2">
									<xsl:for-each select="key('combats','6')">
										<xsl:sort select="@reference" order="ascending"/>
										<xsl:if test="position() = 1">
								...
								<td rowspan="4" class="td_texte2">
									<xsl:for-each select="key('combats','5')">
										<xsl:sort select="@reference" order="ascending"/>
										<xsl:if test="position() = 1">
											<xsl:call-template name="participant2">
												<xsl:with-param name="combat" select="."/>
								...
								<td rowspan="8" class="td_texte2">
									<xsl:for-each select="key('combats','4')">
										<xsl:sort select="@reference" order="ascending"/>
										<xsl:if test="position() = 1">
											<xsl:call-template name="participant2">
												<xsl:with-param name="combat" select="."/>
                    ...
                    <xsl:if test="position() = 2">
                      <xsl:call-template name="vainqueur">
						...
						<!--Tableau à partir des quart-->
						<table class="t1_finale" >
							<tr>
								<td rowspan="1" class="td_texte1">
									<xsl:for-each select="key('combats','2')">
										<xsl:sort select="@reference" order="ascending"/>
	...
	<xsl:template name="participant1">
		...
		<div>
			...
			<div class="col2">
				...
				<xsl:if test="$typeCompetition = '1'">
					<span style="font-size: 0.7em; font-weight:400;margin-right:10px;">
		...
		<div>
			...
			<div class="name">
				...
				<xsl:if test="$typeCompetition = '1'">
					...
					<span style="font-size: 0.7em; font-weight:400;margin-left:10px;">
						<xsl:value-of select="$combat/@firstrencontrelib"/>
					</span>
				</xsl:if>
	...
	<xsl:template name="participant3">
		...
		<div>
			<div class="name">
				...
				<xsl:if test="$combat_prec/@repechage = 'false' and $combat/ancestor::phase[1]/@niveauRepechage = 5 and $combat/ancestor::phase[1]/@niveauRepeches = 6">
					<div class="col1">
						<xsl:text disable-output-escaping="yes">&#032;</xsl:text>

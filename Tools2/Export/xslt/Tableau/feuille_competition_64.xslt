...
<xsl:stylesheet version="1.0"
	...
	<xsl:variable name="IsIntegral">
		<xsl:choose>
			<xsl:when test="//phase[1]/@niveauRepechage = 5 and //phase[1]/@niveauRepeches = 6">
		...
		<html>
			<head>
				...
				<link rel="stylesheet" type="text/css" >
					<xsl:attribute name="href">
						file:///<xsl:value-of select="$style"/>style_feuille_tableau_64.css
					</xsl:attribute>
				</link>
				<title>-60</title>
			</head>
			<body>
				<div class="main">
					...
					<xsl:if test="$IsPhaseValide = 'true'">
												...
												<td>
													...
													<xsl:choose>
														<xsl:when test="$type = 1">
															<xsl:if test="$IsIntegral = 'true'">
																<xsl:attribute name="class">td_texte4</xsl:attribute>
															</xsl:if>
															<xsl:if test="$IsIntegral = 'false'">
	...
	<xsl:template name="participant1">
		...
		<div>
			...
			<div>
				<xsl:if test="$combat/ancestor::phase[1]/@niveauRepechage = 5 and $combat/ancestor::phase[1]/@niveauRepeches = 6">
					<div class="col1">
						<xsl:text disable-output-escaping="yes">&#032;</xsl:text>

...
<xsl:stylesheet version="1.0"
	...
	<xsl:variable name="IsIntegral">
		<xsl:choose>
			<xsl:when test="//phase[1]/@niveauRepechage = 3 and //phase[1]/@niveauRepeches = 4">
			...
			<head>
				...
				<link rel="stylesheet" type="text/css" >
					<xsl:attribute name="href">
						file:///<xsl:value-of select="$style"/>style_feuille_tableau_16.css
					</xsl:attribute>
				</link>

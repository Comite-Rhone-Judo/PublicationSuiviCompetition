									...
									<div class="w3-card">
										...
										<header class="w3-bar w3-light-green w3-large">
											<button class="w3-bar-item w3-light-green" onclick="toggleElement('AvancementFemininesContentPanel')">
												<img class="img" id="AvancementFemininesContentPanelCollapse" width="25" src="../img/up_circular-32.png" style="display: none;"/>
												<img class="img" id="AvancementFemininesContentPanelExpand" width="25" src="../img/down_circular-32.png"/>
												Catégorie féminine
											</button>
										</header>
										<div class="w3-container" id="AvancementFemininesContentPanel" style="display:none">
									...
									<div class="w3-card">
										...
										<header class="w3-bar w3-light-green w3-large">
											<button class="w3-bar-item w3-light-green" onclick="toggleElement('AvancementMasculinsContentPanel')">
												<img class="img" id="AvancementMasculinsContentPanelCollapse" width="25" src="../img/up_circular-32.png" style="display: none;"/>
												<img class="img" id="AvancementMasculinsContentPanelExpand" width="25" src="../img/down_circular-32.png"/>
												Catégorie Masculine
											</button>
										</header>

										<div class="w3-container" id="AvancementMasculinsContentPanel" style="display:none;">

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/*">
		<head>
			...
			<link type="text/css" rel="stylesheet" href="../style/style_combats.css"/>
      ...
      <script src="../js/script.js"></script>-->
		...
		<body>
			...
			<xsl:variable name="epreuve" select="//epreuve[1]/@ID"/>
					...
					<div class="panel-body" style="padding:0px;">
						...
						<div class="panel panel-info">
							<div class="panel-heading clearfix">
								<span style="width: 100%;font-weight: 600;"> Tapis <xsl:value-of
										select="$tapis"/>
								</span>

								<div style="position: fixed;right: 10px;top: 10px;">
									<a class="btn btn-danger" onclick="anim2();"
										style="margin-right: 10px;">
										<img class="img" src="../img/refresh-32.png"
											alt="Actualiser"/>
									</a>
			...
			<div class="panel-body" style="padding:0px;">
				<xsl:for-each select="//tapis">
					...
					<xsl:if
						test="@tapis != 0 and ($istapis != 'epreuve' or count(./combats/combat) &gt; 0)">
	...
	<xsl:template name="combat">
		...
		<xsl:variable name="judoka1"
			select="//participant[@judoka = $participant1]/descendant::*[1]"/>
		...
		<xsl:variable name="judoka2"
			select="//participant[@judoka = $participant2]/descendant::*[1]"/>
				...
				<a href="#" role="button">
					...
					<xsl:choose>
						...
						<xsl:otherwise>
							<span class="right">
								<xsl:value-of
									select="ancestor::tapis[1]/participants/participant[@judoka = $participant1]/descendant::*[1]/@nom"/>
								<xsl:text disable-output-escaping="yes">&#032;</xsl:text>
								<xsl:value-of
									select="ancestor::tapis[1]/participants/participant[@judoka = $participant1]/descendant::*[1]/@prenom"
								/>
							</span>
				...
				<a class="" href="#" role="button">
					...
					<xsl:choose>
						...
						<xsl:otherwise>
							<span class="left">
								<xsl:value-of
									select="ancestor::tapis[1]/participants/participant[@judoka = $participant2]/descendant::*[1]/@nom"/>
								<xsl:text disable-output-escaping="yes">&#032;</xsl:text>
								<xsl:value-of
									select="ancestor::tapis[1]/participants/participant[@judoka = $participant2]/descendant::*[1]/@prenom"
								/>
							</span>

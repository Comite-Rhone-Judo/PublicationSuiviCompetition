									...
									<div class="w3-card">
										...
										<header class="w3-bar w3-light-green w3-large">
											<button class="w3-bar-item w3-light-green" onclick="toggleElement('ClassementFemininesContentPanel')">
												<img class="img" id="ClassementFemininesContentPanelCollapse" width="25" src="../img/up_circular-32.png" />
												<img class="img" id="ClassementFemininesContentPanelExpand" width="25" src="../img/down_circular-32.png" style="display: none;"/>
												Catégorie féminine
											</button>
										</header>
										<div class="w3-container" id="ClassementFemininesContentPanel">
									...
									<div class="w3-card">
										...
										<header class="w3-bar w3-light-green w3-large">
											<button class="w3-bar-item w3-light-green" onclick="toggleElement('ClassementMasculinsContentPanel')">
												<img class="img" id="ClassementMasculinsContentPanelCollapse" width="25" src="../img/up_circular-32.png" />
												<img class="img" id="ClassementMasculinsContentPanelExpand" width="25" src="../img/down_circular-32.png" style="display: none;"/>
												Catégorie Masculine
											</button>
										</header>
									...
									<div class="w3-card">
										<header class="w3-bar w3-light-green w3-large">
											<button class="w3-bar-item w3-light-green" onclick="toggleElement('ClassementNoSexeContentPanel')">
												<img class="img" id="ClassementNoSexeContentPanelCollapse" width="25" src="../img/up_circular-32.png"/>
												<img class="img" id="ClassementNoSexeContentPanelExpand" width="25" src="../img/down_circular-32.png" style="display: none;"/>
												Sans Catégorie
											</button>
										</header>

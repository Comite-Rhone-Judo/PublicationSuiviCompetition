...
namespace Tools.Export
{
    public class ConfigurationExportSite
    {
        ...
        public ConfigurationExportSite(bool pubPC = false, bool pubAT = true, bool pubP = true, long delAC = 30, int nbPC = 6, string pMsg = "", string pLogo = "", bool pec = false, bool ptec = false, int maxpc = 5)
        {

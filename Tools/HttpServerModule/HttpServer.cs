    ...
    public class HttpServer
    {
        ...
        private void ProcessRequest(IHttpClientContext context, IHttpRequest request)
        {
            ...
            try
            {
                ...
                RequestCookies cookies = new RequestCookies(string.Empty); //request.Headers["cookie"] != null ? new RequestCookies(request.Headers["cookie"]) : new RequestCookies(string.Empty);
